        ...
        <nav className="hidden md:flex items-center gap-1 bg-muted/20 p-1 rounded-full border border-border/30">
          {navLinks.map((link) => (
            <Link 
              ...
              href={link.href} 
              className={cn(
                "px-5 py-2 text-[10px] font-black uppercase tracking-widest rounded-full transition-all duration-200",
            ...
            <>
              {session ? (
                <div className="flex items-center gap-2">
                   <Button asChild variant="outline" size="sm" className="rounded-full text-[10px] font-black uppercase tracking-widest h-10 px-5 border-2 hover:bg-primary/5 hidden sm:flex">
                ...
                <Button asChild variant="ghost" size="sm" className="rounded-full text-[10px] font-black uppercase tracking-widest h-10 px-5 hidden sm:flex">
