...
import { PaintBucket, Edit3, MoveRight, Layers, ListFilter, Shapes, X } from "lucide-react";
...
export function ShapePropertiesPanel({ element, onUpdate }: ShapePropertiesPanelProps) {
    ...
    return (
        <AccordionItem value="shape-style" className="border-none">
            <AccordionTrigger className="hover:no-underline py-4 px-4 bg-secondary/20 rounded-xl group">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-bold">Shape Style</span>
                </div>
            </AccordionTrigger>
            <AccordionContent className="px-4 pb-6 pt-4 space-y-4 bg-secondary/10">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <Button
                                        ...
                                        className={cn(
                                            "h-10 flex flex-col items-center justify-center gap-1 text-xs px-1",
                                    ...
                                    >
                                        <div className="w-4 h-4 rounded-full border bg-gradient-to-br from-blue-400 to-purple-500" />
                                        Gradient
                                    </Button>
                                    <Button
                                        variant="outline"
                                    ...
                                    >
                                        <div className="w-4 h-4 rounded-full border bg-gradient-to-r from-red-500 via-yellow-500 to-green-500" />
                                        Stepped
                                    </Button>
                                </div>
                                <Button
                    ...
                    <SectionCard title="Stroke" icon={<Edit3 size={14}/>}>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={element.borderStyle} onValueChange={(v) => handleUpdate({ borderStyle: v as any })}>
