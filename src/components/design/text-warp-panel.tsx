...
import type { DesignElement, GradientStop, Shadow, TextWarp } from "@/lib/types";
import { 
    AlignCenter, AlignJustify, AlignLeft, AlignRight, 
    Bold, CaseLower, CaseUpper, Italic, Strikethrough, 
    Underline, X, AlignStartVertical, AlignCenterVertical, 
    AlignEndVertical, Type, Palette, Layout, ListFilter,
                ...
                <SectionCard title="Layout & Spacing" icon={<Layout size={14}/>}>
                     <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            ...
                            <div className='flex p-1 bg-background/50 rounded-lg border border-border/50'>
                                <Button variant={element.verticalAlign === 'top' ? 'secondary' : 'ghost'} size="icon" className="flex-1 h-8" onClick={() => handleUpdate({verticalAlign: 'top'})}><AlignStartVertical size={14}/></Button>
                                <Button variant={element.verticalAlign === 'middle' || 
                                !element.verticalAlign ? 'secondary' : 'ghost'} size="icon" className="flex-1 h-8" onClick={() => handleUpdate({verticalAlign: 'middle'})}><AlignCenterVertical size={14}/></Button>
                                <Button variant={element.verticalAlign === 'bottom' ? 'secondary' : 'ghost'} size="icon" className="flex-1 h-8" onClick={() => handleUpdate({verticalAlign: 'bottom'})}><AlignEndVertical size={14}/></Button>
                            </div>
                        </div>
                    </div>
