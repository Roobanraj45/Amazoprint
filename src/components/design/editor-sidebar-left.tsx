                                ...
                                <Tooltip key={panel.id} delayDuration={0}>
                                    <TooltipTrigger asChild>
                                        <TabsTrigger
                                            value={panel.id}
                                            className={cn(
                                                "h-[64px] w-full p-0 flex flex-col gap-1.5 items-center justify-center transition-all duration-300 relative group bg-transparent",
                                                "text-muted-foreground/80 data-[state=active]:text-primary hover:text-foreground"
                                            )}
                                            onClick={() => {
                                                if (panel.id === 'pen') return;
                                        ...
                                        >
                                            ...
                                            <div className={cn(
                                                "p-2 rounded-2xl transition-all duration-300 shadow-none group-data-[state=active]:shadow-[0_8px_16px_-4px_rgba(var(--primary),0.25)]",
                                                "group-data-[state=active]:scale-110 group-data-[state=active]:bg-primary/10",
                                                panel.color,
                                                "opacity-80 group-data-[state=active]:opacity-100 group-hover:opacity-100"
                                            )}>
