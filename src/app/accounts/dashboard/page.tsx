...
import { Percent, Landmark, TrendingUp, ArrowRight } from 'lucide-react';
...
export default function AccountsDashboard() {
  const menuItems = [
    ...
    {
        href: '/accounts/settlements',
        label: 'Settlements',
        icon: <Landmark size={24} />,
        description: 'Process payments.',
    },
    {
        href: '/accounts/tracking',
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Welcome back! Manage the finances.</p>
      </div>
