...
import { Home, Trophy, CheckSquare, LogOut, PenSquare, UploadCloud, Palette, ShieldCheck, Package, Bell, Search } from "lucide-react"
...
export default function FreelancerLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    { href: "/freelancer/dashboard", label: "Dashboard", icon: <Home /> },
    { href: "/products", label: "Products", icon: <Palette /> },
    { href: "/contests", label: "Browse Contests", icon: <Trophy /> },
    { href: "/freelancer/contests", label: "My Contests", icon: <CheckSquare /> },
    { href: "/freelancer/orders", label: "My Orders", icon: <Package /> },
    { href: "/freelancer/verifications", label: "Verification Jobs", icon: <ShieldCheck /> },
    { href: "/freelancer/designs", label: "My Designs", icon: <PenSquare /> },
    { href: "/freelancer/my-uploads", label: "My Uploads", icon: <UploadCloud /> },
  ];
