        ...
        <div className="min-h-full p-4 md:p-8 lg:p-10 space-y-8">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 pb-4 border-b border-border/40">
                <div className="space-y-1">
                    <Badge variant="outline" className="bg-emerald-500/10 text-emerald-500 border-emerald-500/20 mb-2 uppercase text-[10px] tracking-widest font-bold">Order History</Badge>
            ...
            {orders.length === 0 ? (
                <Card className="py-32 text-center border-dashed border-border/60 bg-muted/10 shadow-none">
                    <CardContent className="flex flex-col items-center justify-center space-y-6">
                        ...
                        <div className="space-y-2">
                         ...
                         <Button asChild size="lg" className="rounded-xl shadow-lg shadow-emerald-500/20 bg-emerald-500 hover:bg-emerald-600 mt-4 font-bold tracking-widest uppercase text-xs">
                            <Link href="/products">
                ...
                <div className="grid grid-cols-1 gap-6">
                    {orders.map(order => {
                        ...
                        return (
                            <Card key={order.id} className="overflow-hidden border border-border/40 bg-card/40 backdrop-blur-sm shadow-xl shadow-black/5 hover:border-emerald-500/30 hover:shadow-2xl transition-all duration-300 group">
                                <CardHeader className="bg-muted/20 border-b border-border/40 pb-4">
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                        <div className="flex items-center gap-4">
                                            <div className="p-3 bg-background rounded-xl border border-border/50 shadow-sm">
                                                <Package className="w-5 h-5 text-muted-foreground group-hover:text-emerald-500 transition-colors" />
                                            </div>
                                            <div>
                                ...
                                <CardContent className="p-6">
                                     <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                                        <div className="w-24 h-24 bg-muted/50 rounded-2xl flex items-center justify-center flex-shrink-0 border border-border/50 overflow-hidden relative group-hover:border-emerald-500/20 transition-colors">
                                            {imageSrc ? (
                                        ...
                                        <div className="text-right sm:text-right mt-4 sm:mt-0 bg-background/50 p-4 rounded-2xl border border-border/40">
                                            ...
                                            <p className="text-2xl font-black tracking-tighter flex items-center justify-end text-emerald-600">
                                ...
                                <CardFooter className="bg-muted/10 p-4 border-t border-border/40 flex justify-between items-center">
                                    ...
                                    <Button variant="ghost" size="sm" className="font-bold text-xs uppercase tracking-widest hover:text-emerald-500">
